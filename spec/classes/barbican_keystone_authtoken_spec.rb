...
# under the License.
#
# Unit tests for barbican::keystone::authtoken class
#
require 'spec_helper'
...
describe 'barbican::keystone::authtoken' do
  ...
  shared_examples 'barbican authtoken' do
    ...
    context 'with default parameters' do
      ...
      it 'configure keystone_authtoken' do
        ...
        is_expected.to contain_barbican_config('keystone_authtoken/auth_uri').with_value('http://localhost:5000')
        is_expected.to contain_barbican_config('keystone_authtoken/auth_version').with_value('<SERVICE DEFAULT>')
        ...
        is_expected.to contain_barbican_config('keystone_authtoken/keyfile').with_value('<SERVICE DEFAULT>')
        is_expected.to contain_barbican_config('keystone_authtoken/memcache_pool_conn_get_timeout').with_value('<SERVICE DEFAULT>')
        is_expected.to contain_barbican_config('keystone_authtoken/memcache_pool_dead_retry').with_value('<SERVICE DEFAULT>')
        is_expected.to contain_barbican_config('keystone_authtoken/memcache_pool_maxsize').with_value('<SERVICE DEFAULT>')
        is_expected.to contain_barbican_config('keystone_authtoken/memcache_pool_socket_timeout').with_value('<SERVICE DEFAULT>')
        is_expected.to contain_barbican_config('keystone_authtoken/memcache_pool_unused_timeout').with_value('<SERVICE DEFAULT>')
        is_expected.to contain_barbican_config('keystone_authtoken/memcache_secret_key').with_value('<SERVICE DEFAULT>')
        is_expected.to contain_barbican_config('keystone_authtoken/memcache_security_strategy').with_value('<SERVICE DEFAULT>')
        is_expected.to contain_barbican_config('keystone_authtoken/memcache_use_advanced_pool').with_value('<SERVICE DEFAULT>')
        ...
        is_expected.to contain_barbican_config('keystone_authtoken/revocation_cache_time').with_value('<SERVICE DEFAULT>')
        is_expected.to contain_barbican_config('keystone_authtoken/signing_dir').with_value('<SERVICE DEFAULT>')
    ...
    context 'when overriding parameters' do
      ...
      it 'configure keystone_authtoken' do
        is_expected.to contain_barbican_config('keystone_authtoken/auth_uri').with_value('https://10.0.0.1:9999/')
        is_expected.to contain_barbican_config('keystone_authtoken/username').with_value(params[:username])
        is_expected.to contain_barbican_config('keystone_authtoken/password').with_value(params[:password]).with_secret(true)
        is_expected.to contain_barbican_config('keystone_authtoken/auth_url').with_value(params[:auth_url])
        is_expected.to contain_barbican_config('keystone_authtoken/project_name').with_value(params[:project_name])
        is_expected.to contain_barbican_config('keystone_authtoken/user_domain_name').with_value(params[:user_domain_name])
        is_expected.to contain_barbican_config('keystone_authtoken/project_domain_name').with_value(params[:project_domain_name])
        is_expected.to contain_barbican_config('keystone_authtoken/insecure').with_value(params[:insecure])
        is_expected.to contain_barbican_config('keystone_authtoken/auth_section').with_value(params[:auth_section])
        is_expected.to contain_barbican_config('keystone_authtoken/auth_type').with_value(params[:auth_type])
        is_expected.to contain_barbican_config('keystone_authtoken/auth_version').with_value(params[:auth_version])
        ...
        is_expected.to contain_barbican_config('keystone_authtoken/keyfile').with_value(params[:keyfile])
        is_expected.to contain_barbican_config('keystone_authtoken/memcache_pool_conn_get_timeout').with_value(params[:memcache_pool_conn_get_timeout])
        is_expected.to contain_barbican_config('keystone_authtoken/memcache_pool_dead_retry').with_value(params[:memcache_pool_dead_retry])
        is_expected.to contain_barbican_config('keystone_authtoken/memcache_pool_maxsize').with_value(params[:memcache_pool_maxsize])
        is_expected.to contain_barbican_config('keystone_authtoken/memcache_pool_socket_timeout').with_value(params[:memcache_pool_socket_timeout])
        is_expected.to contain_barbican_config('keystone_authtoken/memcache_pool_unused_timeout').with_value(params[:memcache_pool_unused_timeout])
        is_expected.to contain_barbican_config('keystone_authtoken/memcache_secret_key').with_value(params[:memcache_secret_key])
        is_expected.to contain_barbican_config('keystone_authtoken/memcache_security_strategy').with_value(params[:memcache_security_strategy])
        is_expected.to contain_barbican_config('keystone_authtoken/memcache_use_advanced_pool').with_value(params[:memcache_use_advanced_pool])
        ...
        is_expected.to contain_barbican_config('keystone_authtoken/revocation_cache_time').with_value(params[:revocation_cache_time])
        is_expected.to contain_barbican_config('keystone_authtoken/signing_dir').with_value(params[:signing_dir])
  ...
  on_supported_os({
    ...
    context "on #{os}" do
      ...
      it_configures 'barbican authtoken'
    end
  end
