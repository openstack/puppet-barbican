  ...
  shared_examples 'barbican authtoken' do
    ...
    context 'with default parameters' do
      ...
      it 'configure keystone_authtoken' do
        ...
        is_expected.to contain_barbican_config('keystone_authtoken/www_authenticate_uri').with_value('http://localhost:5000')
        ...
        is_expected.to contain_barbican_config('keystone_authtoken/service_type').with_value('<SERVICE DEFAULT>')
    ...
    context 'when overriding parameters' do
      ...
      it 'configure keystone_authtoken' do
        is_expected.to contain_barbican_config('keystone_authtoken/www_authenticate_uri').with_value('https://10.0.0.1:9999/')
        ...
        is_expected.to contain_barbican_config('keystone_authtoken/service_type').with_value(params[:service_type])
